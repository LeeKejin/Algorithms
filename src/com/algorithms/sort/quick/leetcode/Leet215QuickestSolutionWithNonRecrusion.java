...
public class Leet215QuickestSolutionWithNonRecrusion
{
    ...
    {
        int[] nums = new int[] { 6, 5, 7, 9, 4, 3 };
        Leet215QuickestSolutionWithNonRecrusion t = new Leet215QuickestSolutionWithNonRecrusion();
